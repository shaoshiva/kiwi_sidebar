...
class Model_Sidebar extends \Nos\Orm\Model
{
    ...
    protected static $_table_name = 'kiwi_sidebar';
    ...
    protected static $_behaviours = array(
        ...
        */
        ...
        'Nos\Orm_Behaviour_Urlenhancer' => array(
            'enhancers' => array('kiwi_sidebar_sidebar'),
        ),
        */
        /*
    ...
    protected static $_belongs_to  = array(
        ...
        'key' => array( // key must be defined, relation will be loaded via $sidebar->key
            ...
            'model_to' => 'Kiwi\Sidebar\Model_...', // Model to be defined
    ...
    protected static $_has_many  = array(
		'blocs' => array( // key must be defined, relation will be loaded via $sidebar->key
			...
			'model_to' => 'Kiwi\Sidebar\Model_Sidebarbloc', // Model to be defined
